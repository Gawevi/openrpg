...
export default function EquipmentEditorModal(
  props: EditorModalProps<Equipment>
) {
      ...
      <Container fluid>
        <FormGroup controlId="createEquipmentName" className="mb-3">
          ...
          <FormControl
            ...
            onChange={ev =>
              setEquipment(eq => ({ ...eq, name: ev.target.value }))
            }
          />
        </FormGroup>
        ...
        <FormGroup controlId="createEquipmentType" className="mb-3">
          ...
          <FormControl
            ...
            onChange={ev =>
              setEquipment(eq => ({ ...eq, type: ev.target.value }))
            }
          />
        </FormGroup>
        ...
        <FormGroup controlId="createEquipmentDamage" className="mb-3">
          ...
          <FormControl
            ...
            onChange={ev =>
              setEquipment(eq => ({ ...eq, damage: ev.target.value }))
            }
          />
        </FormGroup>
        ...
        <FormGroup controlId="createEquipmentRange" className="mb-3">
          ...
          <FormControl
            ...
            onChange={ev =>
              setEquipment(eq => ({ ...eq, range: ev.target.value }))
            }
          />
        </FormGroup>
        ...
        <FormGroup controlId="createEquipmentAttacks" className="mb-3">
          ...
          <FormControl
            ...
            onChange={ev =>
              setEquipment(eq => ({ ...eq, attacks: ev.target.value }))
            }
          />
        </FormGroup>
        ...
        <FormCheck
          ...
          onChange={ev =>
            setEquipment(eq => ({ ...eq, visible: ev.target.checked }))
          }
