      ...
      <Container fluid>
        ...
        <FormGroup controlId="createSpellDescription" className="mb-3">
          ...
          <FormControl
            ...
            onChange={ev =>
              setSpell(sp => ({ ...sp, description: ev.target.value }))
            }
          />
        </FormGroup>
        ...
        <FormGroup controlId="createSpellDamage" className="mb-3">
          ...
          <FormControl
            ...
            value={spell.damage}
            onChange={ev =>
              setSpell(sp => ({ ...sp, damage: ev.target.value }))
            }
          />
        </FormGroup>
        ...
        <FormGroup controlId="createSpellTarget" className="mb-3">
          ...
          <FormControl
            ...
            value={spell.target}
            onChange={ev =>
              setSpell(sp => ({ ...sp, target: ev.target.value }))
            }
          />
        </FormGroup>
        ...
        <FormGroup controlId="createSpellCastingTime" className="mb-3">
          ...
          <FormControl
            ...
            onChange={ev =>
              setSpell(sp => ({ ...sp, castingTime: ev.target.value }))
            }
          />
        </FormGroup>
        ...
        <FormGroup controlId="createSpellDuration" className="mb-3">
          ...
          <FormControl
            ...
            onChange={ev =>
              setSpell(sp => ({ ...sp, duration: ev.target.value }))
            }
          />
        </FormGroup>
        ...
        <FormCheck
          ...
          onChange={ev =>
            setSpell(sp => ({ ...sp, visible: ev.target.checked }))
          }
