            ...
            {onPlayerSheet && (
              <>
                <Link href="/sheet/player/1" passHref>
                  <Nav.Link active={isActive('/sheet/player/1')}>
                    Página 1
                  </Nav.Link>
                </Link>
                <Link href="/sheet/player/2" passHref>
                  <Nav.Link active={isActive('/sheet/player/2')}>
                    Página 2
                  </Nav.Link>
                </Link>
              </>
            ...
            {onNpcSheet && (
              <>
                <Link href={`/sheet/npc/${router.query.id}/1`} passHref>
                  <Nav.Link active={isActive('/sheet/npc/[id]/1')}>
                    Página 1
                  </Nav.Link>
                </Link>
                <Link href={`/sheet/npc/${router.query.id}/2`} passHref>
                  <Nav.Link active={isActive('/sheet/npc/[id]/2')}>
                    Página 2
                  </Nav.Link>
                </Link>
              </>
