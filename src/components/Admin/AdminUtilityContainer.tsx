...
export default function AdminUtilityContainer(
  props: AdminUtilityContainerProps
) {
  ...
  useEffect(() => {
    setBasicNpcs(
      JSON.parse(localStorage.getItem('admin_npcs') || '[]') as NPC[]
    );
  ...
  return (
    <>
      ...
      <Row className="mb-5 text-center">
        ...
        />
        <CombatContainer
          players={[...props.players, ...basicNpcs, ...complexNpcs]}
        />
      </Row>
    </>
  );
