...
export default function AttributeEditorContainer(
  props: AttributeEditorContainerProps
) {
  const [loading, setLoading] = useState(false);
  const [attributeModal, setAttributeModal] = useState<
    EditorModalData<Attribute>
  >({
    operation: 'create',
    show: false,
  });
...
function AttributeStatusEditorContainer(
  props: AttributeStatusEditorContainerProps
) {
  const [loading, setLoading] = useState(false);
  ...
  function onAttributeStatusModalSubmit({
    id,
    name,
    attribute_id,
  }: AttributeStatus) {
  ...
  return (
    <>
      <DataContainer
        ...
        addButton={{
          onAdd: () =>
            setAttributeStatusModal({ operation: 'create', show: true }),
          disabled: loading,
        }}
      >
        <EditorContainer
      ...
      <AttributeStatusEditorModal
        ...
        onHide={() =>
          setAttributeStatusModal({ operation: 'create', show: false })
        }
