...
const getDatabaseData = () => ({
  ...
  item: [
    ...
    },
    {
      name: 'Mochila',
      description:
        'Uma mochila comum. Descreva aqui seu tamanho e sua capacidade.',
      weight: 0,
      visible: true,
    },
    {
      name: 'Maleta',
      description:
        'Uma maleta comum. Descreva aqui seu tamanho e sua capacidade.',
      weight: 0,
      visible: true,
    },
    {
      name: 'Mala',
      description:
        'Uma mala comum. Descreva aqui seu tamanho e sua capacidade.',
      weight: 0,
      visible: true,
    },
    {
      name: 'Bolsa',
      description:
        'Uma bolsa comum. Descreva aqui seu tamanho e sua capacidade.',
      weight: 0,
      visible: true,
    },
    {
