        ...
        <Container className="text-center">
          ...
          <Row>
            <Col className="h3 mt-2">
              Certifique-se de ter integrado um banco de dados ao aplicativo,
              criado a variável de ambiente <b>CLEARDB_DATABASE_URL</b> e
              preenchido seu valor corretamente.
            </Col>
          </Row>
        </Container>
      </>
